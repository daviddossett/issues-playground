...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        const response = await openai.chat.completions.create({
            model: "gpt-4o-mini",
            messages: [{ role: "user", content: `Create a concise summary of the github issue for based on the content of ${issueBody}. Always tell the user it is generated by OpenAI. Use bullets to make the main points easier to use if appropriate.` }],
            max_tokens: 100,
        });
